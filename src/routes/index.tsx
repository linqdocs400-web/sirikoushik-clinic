...
const GALLERY = [
  ...
  "https://images.unsplash.com/photo-1583912267550-d6c2ac3196c0?w=700&q=70&auto=format&fit=crop",
...
function TopBar() {
  return (
    <div className="bg-ink text-cream/90 text-[10px] sm:text-xs tracking-[0.18em] uppercase">
